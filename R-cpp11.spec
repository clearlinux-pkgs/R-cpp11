...
Version  : 0.5.1
Release  : 39
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/cpp11_0.5.1.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/cpp11_0.5.1.tar.gz
...
%package dev
Summary: dev components for the R-cpp11 package.
Group: Development
Provides: R-cpp11-devel = %{version}-%{release}
Requires: R-cpp11 = %{version}-%{release}

%description dev
dev components for the R-cpp11 package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733396758
